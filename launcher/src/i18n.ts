...
const en = {
  ...
  biggerContextBody: "Warning: keeps small turns as one message, then splits a large initial handoff across two or three messages. The final part starts the task without an extra request. Extra messages may increase rate limits or temporary cooldowns. Disabled by default.",
  ...
  biggerContextRecommendationToggleBody: "Stage a large initial Web handoff across multiple messages.",
  ...
  webRouteNewTasks: "New tasks",
  webRouteHint: "Default for new ChatGPT Web tasks. Existing tasks keep their pinned model and effort.",
  webRouteModel: "ChatGPT Web model",
  webRouteEffort: "ChatGPT Web effort",
  ...
  browserUnresponsive: "ChatGPT's page is not responding. The bridge is still tracking the turn; wait for recovery or inspect the tab before retrying.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "警告：较小回合仍作为一条消息发送；大型初始交接会拆分为两条或三条消息，最后一部分会直接开始任务。额外消息可能提高触发速率限制或临时冷却的概率。默认关闭。",
  ...
  biggerContextRecommendationToggleBody: "将大型初始 Web 交接分成多条消息。",
  ...
  webRouteNewTasks: "新任务",
  webRouteHint: "新 ChatGPT Web 任务的默认值。现有任务会保留已固定的模型和 effort。",
  webRouteModel: "ChatGPT Web 模型",
  webRouteEffort: "ChatGPT Web effort",
  browserAddress: "ChatGPT 浏览器",
  noActiveTask: "当前没有任务",
  noActiveTaskBody: "当 Codex 启动 Web 模型任务时，ChatGPT 会显示在这里。",
  browserReady: "浏览器已就绪",
  browserUnresponsive: "ChatGPT 页面没有响应。桥接器仍在跟踪此轮任务；请等待恢复，或在重试前检查标签页。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "警告：小さなターンは 1 件のメッセージとして維持し、大きな初回ハンドオフは 2～3 件のメッセージに分割します。最後の部分からタスクを開始します。追加メッセージにより、レート制限や一時的なクールダウンが発生しやすくなる場合があります。初期設定では無効です。",
  ...
  biggerContextRecommendationToggleBody: "大きな初回 Web ハンドオフを複数のメッセージに分割します。",
  ...
  webRouteNewTasks: "新しいタスク",
  webRouteHint: "新しい ChatGPT Web タスクの既定値です。既存のタスクでは固定済みのモデルと effort を維持します。",
  webRouteModel: "ChatGPT Web モデル",
  webRouteEffort: "ChatGPT Web effort",
  ...
  browserUnresponsive: "ChatGPT ページが応答していません。ブリッジはターンを追跡中です。回復を待つか、再試行前にタブを確認してください。",
